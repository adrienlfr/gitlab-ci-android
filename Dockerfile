...
# ADB
RUN curl -L0 https://dl.google.com/android/repository/platform-tools-latest-linux.zip > /platform-tools.zip \
 && mkdir -p ${ANDROID_SDK_ROOT}/platform-tools \
 && unzip /platform-tools.zip -d ${ANDROID_SDK_ROOT}/platform-tools \
 && rm -v /platform-tools.zip